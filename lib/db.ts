...
const _dbName = (process.env.DB_ENV ?? process.env.NODE_ENV) === 'production' ? 'sttmount.db' : 'sttmount_dev.db'
const DB_PATH = path.resolve(process.cwd(), `../sttmount/db/${_dbName}`)
